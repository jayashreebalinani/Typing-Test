...
//  function timing() {
//   if(seconds < 60) {
//     time_data.innerHTML = '00:'+seconds;
//   }
//      if (seconds >0 ) {
//          seconds--;
//          timed++;
...
//  var incorrect_words = Math.floor(new_words.length - correct_letters)
// console.log(incorrect_words)
//  var gross_speed = Math.floor((new_words.length)/1)
//  console.log(gross_speed)
 

//  var netspeed = Math.floor((correct_letters)/1)
...
// document.getElementById("gross").innerText=gross_speed;
 

// document.getElementById("net").innerText=netspeed;
